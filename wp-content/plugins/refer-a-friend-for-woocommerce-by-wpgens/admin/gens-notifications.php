...
if(!class_exists('WPGens_Notifications'))
{
    class WPGens_Notifications
    {
        /**
...
if(!function_exists('wpgens_notification'))
{
    function wpgens_notification( $handle, $html, $type = 'success', $dismissible = false, $class = '', $network = false )
    {
        $notifier = WPGens_Notifications::get_instance();
