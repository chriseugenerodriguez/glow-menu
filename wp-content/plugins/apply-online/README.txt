...
Tags: ads manager, job board, career page, contact form, advertisement.
...
Yes, please check plugin reference here.

== Changelog ==

= 1.6.3 =
* Fixed: Underscores between words of form fields names.
* Added: Allowed applications to be deleted.
...
= 1.6 =
* Added: AOL Manager user role.
* Added: Comments system for hiring staff to discuss an application.
* Added: Email validation for form input field.
* Added: More hooks and functions to extend the plugin.
